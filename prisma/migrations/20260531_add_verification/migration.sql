...
-- 7. Add new AuditAction enum values (each ALTER TYPE must be a separate statement)
ALTER TYPE "AuditAction" ADD VALUE IF NOT EXISTS 'BUSINESS_VERIFICATION_REQUESTED';
